...
import com.cristi.storm.HashtagExtractor;
import com.cristi.storm.TwitterSpout;
...
public class TwitterTrendingTopology {
  ...
  public static StormTopology buildTopology(IBatchSpout spout) throws IOException {
    ...
    //5. each hashtag, and how many times it has occurred is emitted
